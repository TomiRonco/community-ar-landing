        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4 sm:space-y-6">
              <div className="group flex items-center p-4 sm:p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-primary-light-pink/20 hover:shadow-xl transition-all duration-300 hover:border-primary-blue/30">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-light-pink to-primary-blue rounded-2xl flex items-center justify-center mr-4 sm:mr-6 group-hover:scale-110 transition-transform duration-300">
